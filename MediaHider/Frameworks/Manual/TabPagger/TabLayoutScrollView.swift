...
class TabLayoutScrollView: UIView {
    ...
    var nextSelectedHeaderButton: customButton?

    fileprivate var bottomLine: UIView?
    fileprivate var selectedHeaderButton: customButton?
    ...
    func drawHeaderView() -> Void {
        ...
        //******************************************************************
        //MARK: Changes done by me
        //******************************************************************
        
        self.bottomLine?.layer.borderColor = UIColor.lightGray.cgColor
        self.bottomLine?.layer.borderWidth = 0.2
    ...
    //MARK:- View Animation
    func autoScrollToScrollView(_ sender:customButton!) {
    ...
    func moveLineWithPageDragging(_ scrollviewOfPageVC: UIScrollView) {
        ...
        if diffrence > 0 {
            ...
            if selectedHeaderButton != nil, let btnAtRightPosition = scrollView?.viewWithTag(selectedHeaderButton!.tag+1) as? customButton {
            ...
            if selectedHeaderButton != nil, let btnAtLeftPosition = scrollView?.viewWithTag(selectedHeaderButton!.tag-1) as? customButton {
    ...
    func moveLineWithOutAnimation(_ btn: customButton) {
    ...
    fileprivate func setSelectedHeaderButtonTextColor(_ tag: Int) {
        ...
        if scrollView != nil {
            for view in scrollView!.subviews {
                if view.isKind(of: customButton.self) {
                    
                    let btn = view as! customButton
                    if btn.tag == tag {
