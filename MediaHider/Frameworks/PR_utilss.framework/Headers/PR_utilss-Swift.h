...
SWIFT_MODULE_NAMESPACE_PUSH("PR_utilss")
@class UIView;

/// Can be <code>UIView</code> or <code>UIBarButtonItem</code>.
SWIFT_PROTOCOL("_TtP9PR_utilss10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC9PR_utilss17AnimatedImageView")
...
SWIFT_CLASS("_TtC9PR_utilss8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(PR_utilss))
...
@interface DropDown (SWIFT_EXTENSION(PR_utilss)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9PR_utilss12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(PR_utilss))
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC9PR_utilss15IQBarButtonItem")
...
SWIFT_CLASS("_TtC9PR_utilss17IQKeyboardManager")
...
SWIFT_CLASS("_TtC9PR_utilss26IQKeyboardReturnKeyHandler")
...
SWIFT_CLASS("_TtC9PR_utilss18IQPreviousNextView")
...
SWIFT_CLASS("_TtC9PR_utilss10IQTextView")
...
SWIFT_CLASS("_TtC9PR_utilss20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC9PR_utilss9IQToolbar")
...
SWIFT_CLASS("_TtC9PR_utilss12MIDatePicker")
@interface MIDatePicker : UIView
...
SWIFT_CLASS("_TtC9PR_utilss19ReachabilityManager")
...
SWIFT_CLASS("_TtC9PR_utilss15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PR_utilss)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PR_utilss)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PR_utilss)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PR_utilss)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PR_utilss)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC9PR_utilss12TaskDelegate")
...
@interface UIBarButtonItem (SWIFT_EXTENSION(PR_utilss)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIImage (SWIFT_EXTENSION(PR_utilss))
- (void)PR_image:(UIImage * _Nonnull)image didFinishSavingWithError:(NSError * _Nullable)error contextInfo:(void const * _Nonnull)contextInfo;
@end
...
@interface UIView (SWIFT_EXTENSION(PR_utilss)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIViewController (SWIFT_EXTENSION(PR_utilss))
